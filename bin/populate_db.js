...
var addEmployees = function(callback) {
    ...
    Emplloyee.create(data.employees, function(error) {
        if (error){
...
var updatEmployeeTeams = function (callback) {
